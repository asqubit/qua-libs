...
if simulate:
    ...
    while results.is_processing():
        ...
        for i, (qubit, rr) in enumerate(zip(qubits, resonators)):
            ...
            plt.pcolor(dcs, (rr.LO_frequency + rr.intermediate_frequency) / u.MHz + dfs / u.MHz, A.T)
            plt.plot(qubit.z.min_offset, (rr.LO_frequency + rr.intermediate_frequency) / u.MHz, "r*")
