...
if simulate:
    ...
    # additional_files = { str(Path(__file__).parent.parent / 'configuration' / v): str(v) for v in ["calibration_db.json", "optimal_weights.npz"]}
    # print(additional_files)
    node_save(machine, "raw_adc_traces", data)
