...
# Single QUA script generated at 2024-07-07 16:53:43.849621
...
with program() as prog:
    ...
    with for_(v1,0,(v1<3000),(v1+1)):
        r1 = declare_stream()
        save(v1, r1)
        with for_(v12,4,(v12<=2996),(v12+4)):
            assign(v13, Cast.mul_fixed_by_int(0.0005,(4*v12)))
            align()
            with strict_timing_():
                play("x90", "q1.xy")
                frame_rotation_2pi(v13, "q1.xy")
                wait(v12, "q1.xy")
                play("x90", "q1.xy")
                play("x90", "q2.xy")
                frame_rotation_2pi(v13, "q2.xy")
                wait(v12, "q2.xy")
                play("x90", "q2.xy")
                play("x90", "q3.xy")
                frame_rotation_2pi(v13, "q3.xy")
                wait(v12, "q3.xy")
                play("x90", "q3.xy")
                play("x90", "q4.xy")
    ...
    with stream_processing():
        r1.save("n")
        r2.buffer(749).average().save("I1")
        r7.buffer(749).average().save("Q1")
        r3.buffer(749).average().save("I2")
        r8.buffer(749).average().save("Q2")
        r4.buffer(749).average().save("I3")
        r9.buffer(749).average().save("Q3")
        r5.buffer(749).average().save("I4")
        r10.buffer(749).average().save("Q4")
        r6.buffer(749).average().save("I5")
        r11.buffer(749).average().save("Q5")
...
loaded_config = {
    ...
    "mixers": {
        "q1.xy_mixer_63a": [{'intermediate_frequency': 385991173.03796864, 'lo_frequency': 4700000000.0, 'correction': (1, 0, 0, 1)}],
        "q1.resonator_mixer_4a5": [{'intermediate_frequency': -287531678.0, 'lo_frequency': 6200000000.0, 'correction': (1, 0, 0, 1)}],
        "q2.xy_mixer_c48": [{'intermediate_frequency': -264564380.79657173, 'lo_frequency': 4700000000.0, 'correction': (1, 0, 0, 1)}],
        "q2.resonator_mixer_13e": [{'intermediate_frequency': -185741282.0, 'lo_frequency': 6200000000.0, 'correction': (1, 0, 0, 1)}],
        "q3.xy_mixer_e89": [{'intermediate_frequency': -236154100.04951477, 'lo_frequency': 4700000000.0, 'correction': (1, 0, 0, 1)}],
        "q3.resonator_mixer_2ac": [{'intermediate_frequency': -343278899.0, 'lo_frequency': 6200000000.0, 'correction': (1, 0, 0, 1)}],
        "q4.xy_mixer_9d2": [{'intermediate_frequency': -284600668.894413, 'lo_frequency': 4700000000.0, 'correction': (1, 0, 0, 1)}],
        "q4.resonator_mixer_b0e": [{'intermediate_frequency': -162578680.0, 'lo_frequency': 6200000000.0, 'correction': (1, 0, 0, 1)}],
        "q5.xy_mixer_cf0": [{'intermediate_frequency': -345901097.018157, 'lo_frequency': 4700000000.0, 'correction': (1, 0, 0, 1)}],
        "q5.resonator_mixer_68d": [{'intermediate_frequency': -257761381.0, 'lo_frequency': 6200000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
